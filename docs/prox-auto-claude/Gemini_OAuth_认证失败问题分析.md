...
pub const GEMINI_OAUTH_CLIENT_SECRET: &str = "YOUR_GOOGLE_OAUTH_CLIENT_SECRET";
```
...
export GEMINI_OAUTH_CLIENT_ID="YOUR_GOOGLE_OAUTH_CLIENT_ID"
export GEMINI_OAUTH_CLIENT_SECRET="YOUR_GOOGLE_OAUTH_CLIENT_SECRET"
```
